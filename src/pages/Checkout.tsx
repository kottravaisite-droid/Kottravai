                            ...
                            {lastOrderDetails && (
                                <div className="bg-purple-50 rounded-xl p-6 text-left mb-8 border border-purple-100">
                                    ...
                                    <div className="mt-4 pt-4 border-t border-purple-200">
                                        ...
                                        <p className="font-semibold text-gray-800">{lastOrderDetails.address}, {lastOrderDetails.city}, {lastOrderDetails.district}, {lastOrderDetails.state} - {lastOrderDetails.pincode}</p>
                                    </div>
                                </div>
                            )}
