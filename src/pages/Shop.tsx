...
import { Filter, ShoppingBag, Heart, Search, ChevronDown, X, Star } from 'lucide-react';
                    ...
                    <div className="flex-1">
                        ...
                        {loading ? (
                            ...
                            <>
                                ...
                                {/* Product Grid */}
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4 justify-items-center">
                                    {currentProducts.map((product) => {
                                        const isInCart = Array.isArray(cart) && cart.some(item => item.id === product.id);
                                        const originalPrice = Number(product.originalPrice || Math.round(Number(product.price || 0) * 1.35));
                                        ...
                                        return (
                                            <div key={product.id} className="group flex flex-col w-full max-w-[280px] bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300">
                                                <div className="relative overflow-hidden bg-[#FAF9F6] aspect-[4/5]">
                                                    ...
                                                    <div className="absolute top-2 left-2 rounded-full bg-white/90 px-2.5 py-0.5 text-[10px] font-black uppercase tracking-[0.18em] text-[#b5128f] shadow-sm">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`absolute bottom-2 right-2 w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 z-20 ${isInWishlist(product.id)
                                                            ? 'bg-[#EC4899] text-white'
                                                            : 'bg-white/90 text-gray-500 hover:bg-[#b5128f] hover:text-white shadow-sm'
                                                            }`}
                                                ...
                                                <div className="p-2 flex flex-col gap-1.5">
                                                    <div className="flex flex-col gap-1.5">
                                                        <h3 className="text-sm font-black text-[#2D1B4E] leading-snug line-clamp-2 group-hover:text-[#b5128f] transition-colors">
                                                            <Link to={`/product/${product.slug}`}>{product.name}</Link>
                                                        </h3>
                                                        <p className="text-xs text-gray-500 line-clamp-2">{product.shortDescription || product.description || 'Premium lightweight handmade jewelry.'}</p>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center justify-between gap-2">
                                                        <div>
                                                            {!product.isCustomRequest && !(product.variants && product.variants.length > 0) ? (
                                                                <div className="flex items-center gap-1.5">
                                                                    ...
                                                                    {hasDiscount && (
                                                                        <span className="text-xs line-through text-gray-300">₹{originalPrice.toLocaleString('en-IN')}</span>
                                                                    )}
                                                                </div>
                                                            ) : (
                                                        ...
                                                        <div className="inline-flex items-center gap-1 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">
                                                    ...
                                                    <div>
                                                        {product.category === 'Essential Care' && (
                                                            <div className="mb-2 inline-flex items-center gap-1 rounded-full bg-red-50 px-2 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-red-600">
                                                                Out of Stock
                                                            </div>
                                                        )}
                                                        ...
                                                        {product.category === 'Essential Care' ? (
                                                            <button
                                                                ...
                                                                className="w-full py-2 text-xs font-black uppercase tracking-[0.16em] transition-all bg-white border border-gray-200 text-gray-500 hover:bg-gray-50"
                                                            >
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                <button
                                                                    ...
                                                                    onClick={(e) => {
                                                                        e.preventDefault();
                                                                        e.stopPropagation();
                                                                        if (product.isCustomRequest || (product.variants && product.variants.length > 0) || Number(product.price) === 0) {
                                                                    ...
                                                                    className="flex-1 py-2 rounded-lg text-xs font-black uppercase tracking-[0.16em] transition-all bg-brandPink text-white hover:bg-brandPurple"
                                                                >
                                                                    Buy Now
                                                                </button>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="w-11 h-11 flex items-center justify-center rounded-[1rem] border border-brandPink text-brandPink transition-all hover:bg-brandPink/10"
                                                                >
                                                                    <ShoppingBag size={16} />
                                                                </button>
                                                            </div>
