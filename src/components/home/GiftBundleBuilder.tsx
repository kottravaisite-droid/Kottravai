                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-[70%]">
                        ...
                        <div className="relative group/carousel">
                            ...
                            <button
                                onClick={() => scroll('left')}
                                className="absolute -left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-2xl border border-gray-100 opacity-0 group-hover/carousel:opacity-100 transition-all hover:bg-[#8E2A8B] hover:text-white"
                            ...
                            <div
                                ref={scrollRef}
                                className="flex gap-6 overflow-x-auto no-scrollbar snap-x snap-mandatory scroll-smooth pb-8 px-10 -mx-10"
                            ...
                            <button
                                ...
                                className="absolute -right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 flex items-center justify-center bg-white rounded-full shadow-2xl border border-gray-100 opacity-0 group-hover/carousel:opacity-100 transition-all hover:bg-[#8E2A8B] hover:text-white"
                    ...
                    <div className="lg:w-[30%]">
                        <div className="sticky top-24 lg:z-20 bg-[#FAF9F6] rounded-[32px] p-6 border border-gray-100 shadow-sm">
                            <div className="mb-6">
