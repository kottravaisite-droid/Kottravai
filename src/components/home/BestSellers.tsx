    ...
    return (
        <section className="py-8 md:py-12 bg-[#FAF9F6]">
            <div className="container mx-auto px-4 max-w-[1240px]">
                ...
                {/* Tab Navigation */}
                <div className="flex justify-center mb-10 overflow-x-auto no-scrollbar border-b border-gray-100">
                    <div className="flex space-x-8 md:space-x-16 text-xs font-bold min-w-max">
